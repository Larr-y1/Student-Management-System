        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <!-- Page content -->
                  ...
                  ">
                          <div class="box">
                          <h1 style="color: #464c5a;">{{ $studentCount }}</h1>
                     ...
                     ">
                          <div class="box">
                          <h1 style="color: #464c5a;">{{ $teacherCount}}</h1>
                     ...
                     ">
                          <div class="box">
                          <h1 style="color: #464c5a;">{{$courseCount}}</h1>
                     ...
                     ">
                       ...
                       <div class="content-2" style=" min-height: 60vh;
                       display: flex;
                       justify-content: space-around;
                       align-items: center;
                       flex-wrap: wrap;">
                          <div class="recent-students" style="min-height: 50vh;
                          flex: 5;
                          background: white;margin: 0 25px 25px 25px;
                          box-shadow: 0 4px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);
                          display: flex;
                          flex-direction: column;
                          ">
                             <div class="heado" style="display: flex;
                             align-items: center;
                             justify-content: space-around;
                             padding: 15px 10px;
                             border-bottom: 2px solid #999;">
                                <h2>Students hub</h2>
                               <a href="{{'/student/views/'}}" class="btn btn-info" ><button style="background-color: DodgerBlue; /* Blue background */
                                border: none; /* Remove borders */
                                color: white; /* White text */
                                padding: 12px 16px; /* Some padding */
                                font-size: 16px; /* Set a font size */
                                cursor: pointer;" class="btn"><i class="fa fa-home"></i> View</button>
                               </a>
                             </div>
                             <table style="padding: 8px;">
                                <tr>
                                  <th style="
                                  text-align: left;
                                  padding: 15px;">Firstname</th>
                                  <th style="
                                  text-align: left;
                                  padding: 15px;">Lastname</th>
                                  <th style="
                                  text-align: left;
                                  padding: 15px;">Email</th>
                                  <th style="
                                  text-align: left;
                                  padding: 15px;">Phone</th>
                                  <th style="
                                  text-align: left;
                                  padding: 15px;">Option</th>
                                </tr>
                                ...
                                <td style="
                                text-align: left;
                                padding: 15px;">{{$student->firstname}} </td>
                                <td style="
                                text-align: left;
                                padding: 15px;">{{$student->lastname}}</td>
                                <td style="
                                text-align: left;
                                padding: 15px;">{{$student->email}}</td>
                                <td style="
                                text-align: left;
                                padding: 15px;">{{$student->contact}}</td>
                                <td style="
                                text-align: left;
                                padding: 15px;">
                                 <a href="{{'/student/views/'}}" class="btn btn-info" ><button style="background-color: DodgerBlue; /* Blue background */
                                    ...
                                    padding: 12px 16px; /* Some padding */
                                    font-size: 16px; /* Set a font size */
                                    cursor: pointer;" class="btn"></i> View</button>
                                   </a>
                             ...
                             @endforeach
                                  ...
                                  <div class="recent-teachers" style="flex: 2;
                                  min-height: 50vh;
                                  margin: 0 25px 25px;
                                  background: white;
                                  box-shadow: 0 4px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);
                                ...
                                <a href="{{'/teachers/View'}}" class="btn btn-info" ><button style="background-color: DodgerBlue; /* Blue background */
                                    border: none; /* Remove borders */
                                    color: white; /* White text */
                                    padding: 12px 16px; /* Some padding */
                                    font-size: 16px; /* Set a font size */
                                    cursor: pointer;" class="btn"><i class="bi bi-person-video2"></i></i>  View</button>
                                   </a>
                             </div>
                             <table style="padding: 8px;">
                                <tr>
                             ...
                             @foreach ($recentTeachers as $teacher)
                                ...
                                <tr>
                                   <td style="
                                   text-align: left;
                                   padding: 15px;"><img src="{{asset('storage/ter.jpeg') }}" alt="" style="height: 70px;"></td>
                                   <td style="
                                   text-align: left;
                                   padding: 15px;">{{$teacher->firstname}}</td>
                                   <td style="
                                   text-align: left;
                                   padding: 15px;">{{$teacher->lastname}}</td>
                                   <td style="
                                   text-align: left;
                                   padding: 15px;">{{$teacher->email}}</td>
                                   ...
                                   <a href="{{'/teachers/View'}}" class="btn btn-info" ><button style="background-color: DodgerBlue; /* Blue background */
                                    ...
                                    padding: 12px 16px; /* Some padding */
                                    font-size: 16px; /* Set a font size */
                                    cursor: pointer;" class="btn"><i class="btn"></i> View</button>
                                   </a>
                                </tr>
                                @endforeach
